...
print('The CPU usage is: ', psutil.cpu_stats())
print('The CPU usage is: ', psutil.cpu_freq())
...
print('RAM Total (GB):', psutil.virtual_memory()[0]/1073741824)
# Getting usage of virtual_memory in GB ( 4th field)
print('RAM Used (GB):', psutil.virtual_memory()[3]/1073741824)
print('RAM Free (GB):', psutil.virtual_memory()[4]/1073741824)
# Getting % usage of virtual_memory ( 3rd field)
print('RAM memory % used:', psutil.virtual_memory()[2])

import gpustat
print(gpustat.is_available())
# print(gpustat.print_gpustat())
# print(gpustat.main())
print(gpustat.cli.GPUStatCollection().jsonify())
...
# def link_connection_to_process():
#     for connection in ps.net_connections():
#         try:
#             print(ps.Process(pid=connection.pid).name(),connection)
#
#         except ps.AccessDenied:
#             continue # Keep going if we don't have access
#
# link_connection_to_process()
